extern HFONT framefont, espfont, specfont, mFont, osFont, sFont, tFont, cFont, heading, o4Font_20, o4Font_11, o4Font_03;
...
public:
    ...
    bool MoveWindow(int & x, int & y, int w, int h, int index);
