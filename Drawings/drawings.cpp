...
HFONT framefont, espfont, specfont, mFont, osFont, sFont, tFont, cFont, heading, o4Font_20, o4Font_11, o4Font_03;
...
void cdrawings::DrawCircle(Vector2D position, float points, float radius, Color color)
{
...
bool cdrawings::MoveWindow(int & x, int & y, int w, int h, int index) {
...
void cdrawings::drawcolorpicker(int x, int y, const char *szString, Color &col) { // Rectangle
    int oner = 6;
